...
<p>Step1: Click the below button to create event stream instance. Choose lite plan, select the region, give a service name and finally click on create button.</p>
