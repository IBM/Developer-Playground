...
export var areaDiscreteDomainOptions = {
...
export var sparklineTimeSeriesData = [
...
export var boundedAreaTimeSeriesData = [
    {
        group: 'Dataset 1',
...
export var boundedAreaTimeSeriesOptions = {
...
export var areaSkeletonData = boundedAreaTimeSeriesData;
export var areaSkeletonOptions = {
    title: 'Area (skeleton)',
    bounds: {
        upperBoundMapsTo: 'max',
        lowerBoundMapsTo: 'min',
