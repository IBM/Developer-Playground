  ...
  function FilterableMultiSelect(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOnStateChange", function (changes, downshift) {
      ...
      switch (type) {
        ...
        case Downshift.stateChangeTypes.keyDownArrowDown:
          ...
          if (!_this.state.isOpen) _this.handleOnMenuChange(true);
          break;

        case Downshift.stateChangeTypes.keyDownEscape:
        case Downshift.stateChangeTypes.mouseUp:
          if (_this.state.isOpen) _this.handleOnMenuChange(false);
          break;
        ...
        case Downshift.stateChangeTypes.keyDownSpaceButton:
          {
            ...
            if (_this.state.isOpen !== nextIsOpen) _this.handleOnMenuChange(nextIsOpen);
            break;
          }
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOnInputValueChange", function (inputValue, _ref2) {
      ...
      if (type === Downshift.stateChangeTypes.changeInput) {
        ...
        if (Boolean(inputValue) !== _this.state.isOpen) _this.handleOnMenuChange(Boolean(inputValue));
      }
    });
