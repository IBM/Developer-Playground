...
var Tab = /*#__PURE__*/function (_React$Component) {
  ...
  function Tab() {
    ...
    _defineProperty(_assertThisInitialized(_this), "tabId", _this.props.id || "tab-".concat(getInstanceId()));
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var buttonProps = (_buttonProps = {}, _defineProperty(_buttonProps, 'aria-selected', selected), _defineProperty(_buttonProps, 'aria-disabled', disabled), _defineProperty(_buttonProps, 'aria-controls', "".concat(this.tabId, "__panel")), _defineProperty(_buttonProps, "id", this.tabId), _defineProperty(_buttonProps, "className", "".concat(prefix, "--tabs--scrollable__nav-link")), _defineProperty(_buttonProps, "href", href), _defineProperty(_buttonProps, "tabIndex", !disabled ? tabIndex : -1), _defineProperty(_buttonProps, "ref", function ref(e) {
        _this2.tabAnchor = e;
      }), _buttonProps);
      ...
      return /*#__PURE__*/_react.default.createElement("li", _extends({}, other, {
        ...
        role: "presentation"
      }), renderElement ? renderElement(buttonProps) : /*#__PURE__*/_react.default.createElement("button", _extends({
        type: "button",
        role: "tab"
      }, buttonProps), label));
    }
