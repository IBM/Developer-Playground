  ...
  <div class="section" style="font-size: 16px; margin-top: -20px">
   ...
   <br>
    ...
    <div class="footer" style="margin-left:30px;">      
        ...
        <a class="button is-dark is-medium" title="Re-Launch Application" href="didact://?commandId=extension.sendToTerminal&text=ChurnPrediction%7Crestart-app%7Csandbox%20terminal|cd%20${CHE_PROJECTS_ROOT}/churn-prediction;cd%20client;npm%20install;npm%20run%20build;cd..;npm%20start">Re-Launch Application</a>
