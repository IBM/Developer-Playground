   ...
   <div class="timeline">
      ...
      <div class="container right">
         <div class="content">
            ...
            <p style="margin-top:10px;">Do not have an IBM Cloud Paid Account? <a href="didact://?commandId=extension.getResource&text=nlu%2Cnlu.json">click here</a> to get the Natural Language Understanding credentials.</p>
            <p style="margin-top:10px;"><a href="didact://?commandId=extension.getResource&text=ta%2Cta.json">click here</a> to get the  Tone Analyzer credentials.</p>
             <p style="margin-top:10px;"><a href="didact://?commandId=extension.getResource&text=ta%2Cstt.json">click here</a> to get the  Speech to Text credentials.</p>
         </div>
      </div>
      <div class="container right">
         <div class="content">
