...
<body>
   ...
   <div class="footer">
      <div class="content" style="padding:30px;padding-left:60px;padding-bottom: 0px;">
         ...
         <a class="button is-dark is-medium" title="Delete services from IBM Cloud" href="didact://?commandId=vscode.didact.sendNamedTerminalAString&text=sandbox%20terminal$$sh%20/github.sh ">Push the code to your personal GITHUB repo</a>
         <p style="margin-top:10px;">You can push the code to your github repo, You need to have git authentication ID, you can get from here <a href="https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token">GITHUB</a>.</p>
      </div>
      <div class="image-div">
