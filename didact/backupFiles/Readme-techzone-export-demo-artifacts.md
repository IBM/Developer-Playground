                ...
                <details>
                    ...
                    <div>
                        ...
                        <a class="button is-dark is-medium" title="Export User List"
                            href="didact://?commandId=vscode.didact.sendNamedTerminalAString&&text=sandbox terminal$$cd /projects/techzone-demo/sandbox/;python exportUsersv2.py users.csv">Export
                            User List</a>
                        <span class="dot"></span>
                    </div>
                </details>
