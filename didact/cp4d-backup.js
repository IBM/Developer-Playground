window.onload = function () {
    ...
    let prerequisite = ["src_server", "src_api_token", "kubeadmin_user", "kubeadmin_pass", "icr_key", "s3_url","bucket","region","access_key","access_id" ]
    ...
    if ((localData.src_server.trim() === "" || localData.src_api_token.trim() === "" || localData.icr_key.trim() === "" || localData.s3_url.trim() === "" || localData.bucket.trim() === "" || localData.region.trim() === "" || localData.access_key.trim() === "" || localData.access_id.trim() === "") && (localData.kubeadmin_user.trim() === "" || localData.kubeadmin_pass.trim() === "" || localData.icr_key.trim() === "" || localData.s3_url.trim() === "" || localData.bucket.trim() === "" || localData.region.trim() === "" || localData.access_key.trim() === "" || localData.access_id.trim() === "")) {
    ...
    function getEnvValues(e) {
      ...
      let valid = true
      if ((config.src_server.trim() === "" || config.src_api_token.trim() === "" || config.icr_key.trim() === "" || config.s3_url.trim() === "" || config.bucket.trim() === "" || config.region.trim() === "" || config.access_key.trim() === "" || config.access_id.trim() === "") && (config.kubeadmin_user.trim() === "" || config.kubeadmin_pass.trim() === "" || config.icr_key.trim() === "" || config.s3_url.trim() === "" || config.bucket.trim() === "" || config.region.trim() === "" || config.access_key.trim() === "" || config.access_id.trim() === ""))
        valid = false
      if (valid) {
        let configCTA = timelineContainer.getElementsByClassName("timeline")[0]
        configCTA.style.opacity = 1;
