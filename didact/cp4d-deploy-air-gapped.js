...
function mirrorImage(e) {
  ...
  console.log(data)
  document.getElementById("mirror-image$1").setAttribute("command", "cp ${CHE_PROJECTS_ROOT}/techzone-demo/olm-utils-v2/cp4d-config.yaml /opt/ansible/cpd-config/config/cpd-config.yaml;" + "cd ${CHE_PROJECTS_ROOT}/scripts;"+`python3.8 get-data.py '${data}'`)
