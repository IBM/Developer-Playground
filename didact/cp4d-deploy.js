...
const DEFAULT_CP4D_VERSION = "4.7.1"
...
function install_cpd() {
  ...
  document.getElementById("install_cpd$1").setAttribute("command", "cd ${CHE_PROJECTS_ROOT}/techzone-demo/olm-utils-v2;" + `python updateYaml.py  ${component_list} ${storage} ${cp4dVersion} cp4d;bash deploy.sh cp4d '${data}'`)
