window.onload = function () {
  let compositeHref = "git clone https://github.com/IBM/CPDemoFramework -b ${BRANCH} --single-branch techzone-demo;cd%20./techzone-demo/olm-utils-v2;sh%20configure-env.sh%20"
