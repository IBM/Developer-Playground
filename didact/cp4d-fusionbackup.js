...
let configureCommand = "git clone https://github.com/IBM/CPDemoFramework -b ${BRANCH} --single-branch ${CHE_PROJECTS_ROOT}/techzone-demo;cd ${CHE_PROJECTS_ROOT}/techzone-demo/sandbox/fusion;sh configure-env.sh ";
...
function run_backup() {
    ...
    document.getElementById("run_backup$1").setAttribute("command", "cd ${CHE_PROJECTS_ROOT}/techzone-demo/sandbox/fusion;" + `bash fusion-setup.sh backup ${backupstoragelocation_name} ${backuppolicy_name} ${backup_name}`)
