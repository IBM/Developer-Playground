window.onload = function () {
    ...
    function install_cr() {
      ...
      document.getElementById("command_exec").href =
        "didact://?commandId=vscode.didact.sendNamedTerminalAString&&text=sandbox%20terminal$$cd%20${CHE_PROJECTS_ROOT}/techzone/olm-utils-v2/;pip%20install%20PyYAML;python%20updateYaml.py%20"+component_list+"%20"+storage+"%20"+cp4dVersion+"%20cp4d;bash deploy.sh cp4d";
      document.getElementById("command_exec").click();
    }
