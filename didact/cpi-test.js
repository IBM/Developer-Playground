window.onload = function () {
  ...
  function install_cpi() {
    ...
    document.getElementById("command_exec").href =
      "didact://?commandId=vscode.didact.sendNamedTerminalAString&&text=sandbox%20terminal$$cd%20${CHE_PROJECTS_ROOT}/techzone/olm-utils-v2/;pip%20install%20PyYAML;python%20updateYaml.py%20"+component_list+"%20"+storage+"%20"+cp4iVersion+"%20cp4i;bash deploy.sh cp4i";    
