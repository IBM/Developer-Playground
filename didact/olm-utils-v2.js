window.onload = function () {
  ...
  let services = {
    ...
    cpd-platform: 'Cloud Pak for Data Control Plane',
    ...
    edb-cp4d: 'EnterpriseDB Postgres',
    hadoop: 'Execution Engine for Apache Hadoop',
    iis: "WKC's IIS component",
    informix: 'Informix install Operator',
    informix-cp4d: 'Informix deployment Operator',
    match360: 'Match 360 with Watson',
    model-train: 'IBM cloudpak operator for training with Model Train',
    mongodb: 'MongoDB Operator',
    mongodb-cp4d: 'MongoDB for Cloud Pak for Data',
    openpages: 'OpenPages',
    openpages-instance: 'OpenPages Instance',
    ...
    productmaster-instance: 'Product Master Instance',
    ...
    watson-gateway: 'IBM Watson Gateway Operator',
