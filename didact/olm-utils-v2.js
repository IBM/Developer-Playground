window.onload = function () {
    ...
    let compositeHref = "didact://?commandId=extension.compositeCommand&&text=terminal-for-sandbox-container:new%7Cvscode.didact.sendNamedTerminalAString%2Csandbox%20terminal%2Cgit clone https://github.com/IBM/CPDemoFramework -b $BRANCH --single-branch techzone;cd%20${CHE_PROJECTS_ROOT}/techzone/olm-utils-v2;python3.8%20update-env-vars.py%20"
    ...
    //   document.getElementById("command_exec").click();
    document.getElementById("command_exec").href =
      "didact://?commandId=vscode.didact.sendNamedTerminalAString&&text=sandbox%20terminal$$cd%20${CHE_PROJECTS_ROOT}/techzone/olm-utils-v2/;python3.8%20updateYaml.py%20"+preview_value+"%20"+release_version+"%20"+component_list+"%20"+license_acceptance+"%20"+cr_cpd_instance+"%20"+storage;
    document.getElementById("command_exec").click();
    }
    // Preview logic
