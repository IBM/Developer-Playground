...
with open("Producer.js",'r') as contents:
      save = contents.read()
with open("Producer.js",'w') as contents:
...
with zipfile.ZipFile("Producer.zip", mode="a") as archive:
    archive.write("Producer.js")
data = json.loads(os.popen("aws lambda create-function --function-name Producer --role "+iam_arn+" --runtime nodejs14.x --zip-file fileb://Producer.zip --handler Producer.js").read())
print(data)
